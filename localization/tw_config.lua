...
Config.Animations = {
...

	{
	    ...
	    {label = "做生意", type = "attitude", data = {lib = "move_m@business@a", anim = "move_m@business@a"}},
	    ...
	    {label = "吃太飽", type = "attitude", data = {lib = "move_m@fat@a", anim = "move_m@fat@a"}},
	    {label = "潮他媽的", type = "attitude", data = {lib = "move_m@hipster@a", anim = "move_m@hipster@a"}},
	    {label = "受傷", type = "attitude", data = {lib = "move_m@injured", anim = "move_m@injured"}},
	    ...
	    {label = "拿鐵鎚敲牆", type = "attitude", data = {lib = "move_m@money", anim = "move_m@money"}},
